...
function updateCanvas() {
    ...
    sketch = element_of_array;
    document.getElementById("sketch_to_be_drawn").innerHTML = "Try drawing : " + sketch;
}
...
function gotResults(error, results) {
    ...
    document.getElementById("your_sketch").innerHTML = "I think it is : " + results[0].label;
    document.getElementById("confidence").innerHTML = "MY Confidence is : " + Math.round(results[0].confidence * 100) + "%";
}
